...
$(function() {
    ...
    $('#registerForm').validate({
        ...
        messages: {
            //用户名提示信息
            username: {
                required: '用户名不能为空哦！', //非空
                rangelength: '长度在3~6位哦' //长度验证
            },
            //密码的提示信息
            password: {
                required: '密码不能为空哦！', //非空
                isPassword: '亲！输入5-10个字母开头、可带数字、“_”、“.”的字符串哟!' //密码格式提示
            },
            //确认密码提示信息
            checkPassword: {
                required: '请再次输入密码哦！', //非空
                equalTo: '两次密码不一致' //密码的一致性验证
            },
            //电话号码
            tel: {
                required: '电话号码不能为空哦！', //非空
                isTel: '电话号码格式不正确' //电话号码的验证
            }
        }
    })
